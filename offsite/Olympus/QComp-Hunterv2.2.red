Path: ibmpcug!wendy.ibmpcug.co.uk!pipex!howland.reston.ans.net!gatech!nntp.msstate.edu!nntp.memphis.edu!nntp.rhodes.edu!harlie.mathcs.rhodes.edu!graham
Newsgroups: rec.games.corewar
Subject: QCmpHunt
Message-ID: <1995Mar21.175657.2218@rhodes>
From: graham@harlie.mathcs.rhodes.edu (Randy Graham)
Date: 21 Mar 95 17:56:56 -0500
Nntp-Posting-Host: harlie.mathcs.rhodes.edu
X-Newsreader: TIN [version 1.2 PL2]
Lines: 147

OK, finally I have had time to comment the QScan version of Hunter
enough that it might be of use to someone.  So, below is latest
version, slightly updated from the last I had on the 94 hill.  I never
made it above 18th, and only lasted through 5 challenges before
falling off (and 3 I survived were versions of P.Kline's Paper
Dreaming).  

After this has been here a couple of days I will put up my 55440
version of QCmpHunter.  He did significantly better on the big hill
(10th I believe).  

One other thing.  Some of you will probably notice Hunter looks
suspiciously like S.Strack's Rave.  I came across this code honestly
though.  I took a jmz hunter and converted it to a cmp hunter and
after playing around found this to be the most succesful.  Apologies
for the similarities, but this seems to be about the best I can
manage, and I imagine Rave came about the same way (tweak until it
